...
export default function OrderDetailsWithDataShop(
  ...
  const foodId = props.data.productSize.product.id;
  const listIngredients = props.data.orderIngredientDetail;
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View>
        ...
        <ItemOrder
          ...
          priceValue={props.data.fullPrice}
          amount={props.data.count}
          listIngredients={listIngredients}
          onPressItem={() =>
            props.navigation.navigate('FoodDetailsScreen', {foodId: foodId})
          }
        />
      </View>
